...
- Subagents: read `/Users/maxpetrusenko/Desktop/Projects/agent-scripts/docs/subagent.md`.
- Skills: load from `/Users/maxpetrusenko/Desktop/Projects/skills/AGENTS.md`.
- Project-local agent configs: when `.agents/` exists, load `.agents/skills.must.txt`, `.agents/skills.good.txt`, `.agents/skills.task.txt`, and the matching `.agents/agents/<role>.md`.
